...
#if QT_CONFIG(tooltip)
        self.label_movie.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p>作业</p><p>官网：<a href=\"http://zs.yjs.cqut.edu.cn//\"><span style=\" text-decoration: underline; color:#0000ff;\"></a></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
